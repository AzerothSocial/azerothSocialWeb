                        ...
                        <div key={app.id} className="bg-[#141923] border border-[#263045] rounded-2xl p-5 flex flex-col gap-4 shadow-lg relative overflow-hidden transition-all hover:border-[#38435C] flex-shrink-0">
                          ...
                          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                            ...
                            <div className="shrink-0">
                              <span className={`inline-flex items-center justify-center whitespace-nowrap gap-1.5 text-[10px] font-bold px-3 py-1.5 rounded-lg border uppercase tracking-wider shadow-sm ${app.status === 'approved'
